...
def temp_xdg(tmpdir, mocker):
    ...
    mocker.patch(
        ...
        new=[xdg.BaseDirectory.xdg_config_home]  # pyright: ignore[reportGeneralTypeIssues]
    )
    mocker.patch(
        "xdg.BaseDirectory.xdg_data_dirs",
        new=[xdg.BaseDirectory.xdg_data_home]  # pyright: ignore[reportGeneralTypeIssues]
    )
