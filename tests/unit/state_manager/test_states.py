...
class TestStates:
    ...
    def test_load_missing_state(self, new_dir, step):
        state = states.load_state(Part("missing", {}), step)
        assert state is None

    def test_load_pull_state(self, new_dir):
        state_data = {
    ...
    def test_load_build_state(self, new_dir):
        state_data = {
    ...
    def test_load_stage_state(self, new_dir):
        state_data = {
            "part-properties": {"plugin": "nil"},
            "project-options": {"target_arch": "amd64"},
            "files": {"a"},
    ...
    def test_load_prime_state(self, new_dir):
        state_data = {
            "part-properties": {"plugin": "nil"},
            "project-options": {"target_arch": "amd64"},
            "files": {"a"},
