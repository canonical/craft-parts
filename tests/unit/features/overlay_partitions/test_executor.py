...
class TestExecutor:
    ...
    @pytest.mark.parametrize(("parts", "level"), [
        ([], 0),
        ([Part("p1", {"plugin": "nil"})], 0),
        ([Part("p1", {"plugin": "nil"}), Part("p2", {"plugin": "nil"})], 0),
        ([Part("p1", {"plugin": "nil", "organize": {"foo": "(overlay)/bar"}}), Part("p2", {"plugin": "nil"})], 1),
        ([Part("p1", {"plugin": "nil"}), Part("p2", {"plugin": "nil", "organize": {"foo": "(overlay)/bar"}})], 0),
    ])
