...
def test_poetry_plugin(new_dir, partitions, source_directory, parts_dict):
    ...
    lf = LifecycleManager(
        parts_dict, application_name="test_poetry", cache_dir=new_dir, partitions=partitions
    )
...
def test_poetry_plugin_override_get_system_interpreter(new_dir, partitions, source_directory, parts_dict):
