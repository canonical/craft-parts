...
- Relative symbolink links produced during the build step are now correctly checked for
  collisions with absolute symbolink links from the overlay during the stage step.
