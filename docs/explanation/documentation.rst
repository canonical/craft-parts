.. meta::
  :description: An explanation of the documentation system, process, and writing style and conventions in Craft Parts.
...
The documentation is an essential part of Craft Parts. We make documentation a disciplined
...
Craft Parts practices docs-as-code. The document source files are written in
reStructuredText markup and kept inside the Craft Parts source code. Like the rest of the
...
The Craft Parts maintainers try and review every PR in a timely manner, typically within a
...
There is no single way to write, but there are guidelines and patterns that Craft Parts
documents follow:
