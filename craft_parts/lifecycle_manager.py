...
class LifecycleManager:
    ...
    :param application_name: A unique non-empty identifier for the application
        using Craft Parts. This string will be used as segregated directory path
        when creating persistent data that shouldn't be shared with other
        applications and as a prefix to step environment variable names. Valid
        application names contain upper and lower case letters, underscores
        or numbers, and must start with a letter.
