...
class LifecycleManager:
    ...
    :param application_name: A unique non-empty identifier for the application
        using Craft Parts. The application name is used as a prefix to step
        environment variables, and as a component of the cache directory path if
        it's not set by the application. Valid application names contain upper
